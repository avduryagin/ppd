...
"Дата ввода",
HH.NE_1 "Состояние",
decode(pipe_prostoy_uchastok."Состояние", 'HH0004',null,TO_char(pipe_prostoy_uchastok."Дата изменения состояния",'dd.mm.yyyy')) "Дата перевода в бездействие",
"Дата аварии",
...
{pipe_condition}
{material_condition}
/*and pipe_avaria."ID простого участка"='25389'*/
order by pipe_avaria."ID простого участка","Дата аварии"
/*and  ((pipe_prostoy_uchastok."Состояние" ='HH0004') or (pipe_prostoy_uchastok."Состояние" <>'HH0004' and pipe_prostoy_uchastok."Дата изменения состояния" >"Дата аварии" )   )
/*and  and  pipe_remont."ID участка"(+)=pipe_uchastok_truboprovod."ID участка"
and  pipe_rem.Ret_ut_L( pipe_avaria."ID простого участка",
     pipe_uchastok_truboprovod."ID участка",
     PIPE_AVARIA."Адрес от начала участка" ) between  pipe_remont."Адрес от начала участка"  and pipe_remont."Адрес от начала участка"+pipe_remont."Длина ремонтируемого участка"

and   pipe_remont."Дата окончания ремонта" >"Дата аварии"
and "Тип ремонта" IN   ('HM0004','HM0013', 'HM0029', 'HM0014',  'HM0012',  'HM0006')*/
--order by pipe_avaria."ID простого участка","Дата аварии"